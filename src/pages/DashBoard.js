                ...
                <div className="grafica-box">
                    ...
                    <ResponsiveContainer width="100%" height="100%">
                        <BarChart data={dataGraf} margin={{ top: 20, right: 30, left: 10, bottom: 5 }}>
                            ...
                            <Bar dataKey="no_participa" stackId="a" fill="#f44336" name="No participa" />
                            <Bar dataKey="datos_incorrectos" stackId="a" fill="#9c27b0" name="Datos incorrectos" />
                            <Bar dataKey="marcar_después" stackId="a" fill="#607d8b" name="Marcar después" />
                            <Bar dataKey="pendiente" stackId="a" fill="#607d8b" name="Pendiente" />
                        </BarChart>
                    </ResponsiveContainer>
                </div>
