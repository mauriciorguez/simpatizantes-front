...
export default function ContactListDistrito() {
  ...
  const handleWhatsApp = (contact) => {
    ...
    const message = 'Hola, excelente día! Espero estés muy bien, necesitamos confirmar tu valioso apoyo para vigilar el voto en estas elecciones siendo nuestro Representante de Casilla para poder defender el voto de Movimiento Ciudadano. ¿Confirmas tu participación como Representante de Casilla? ¡Gracias, tu ayuda es clave para asegurar unas elecciones justas y transparentes!';
